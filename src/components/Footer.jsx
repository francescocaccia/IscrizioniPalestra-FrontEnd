                ...
                <ul className="navbar-nav">
                  <li className="nav-item">
                    <svg
                      ...
                      height="24"
                      fill="currentColor"
                      className="bi bi-facebook icon-hover text-secondary me-2"
                      viewBox="0 0 16 16"
                    >
                    ...
                    <svg
                      ...
                      height="24"
                      fill="currentColor"
                      className="bi bi-instagram icon-hover text-secondary me-2"
                      viewBox="0 0 16 16"
                    >
                    ...
                    <svg
                      ...
                      height="24"
                      fill="currentColor"
                      className="bi bi-twitter icon-hover text-secondary me-2"
                      viewBox="0 0 16 16"
                    >
                    ...
                    <svg
                      ...
                      height="24"
                      fill="currentColor"
                      className="bi bi-youtube icon-hover text-secondary me-2"
                      viewBox="0 0 16 16"
                    >
